            ...
            <div className="flex justify-center gap-6">
              ...
              >
                <svg className="w-10 h-10 text-[#F5F0ED]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.1 11.8C18.6 7.5 15.4 4 11.5 4 6.8 4 3 7.8 3 12.5c0 2.1.8 4 2.1 5.5C4.2 18.6 3.5 19.5 3.5 20.5c0 1.4 1.1 2.5 2.5 2.5 1 0 1.9-.6 2.3-1.5 1 .3 2.1.5 3.3.5 1.1 0 2.2-.2 3.2-.5.4.9 1.3 1.5 2.3 1.5 1.4 0 2.5-1.1 2.5-2.5 0-1-.8-2-1.7-2.3 1.2-1.5 1.8-3.4 1.8-5.4 0-.3 0-.6-.1-.9zM6 21.5c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1zm5.5-5c-1.9 0-3.5-1.6-3.5-3.5S9.6 9.5 11.5 9.5s3.5 1.6 3.5 3.5-1.6 3.5-3.5 3.5zm6 5c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1z"/>
                </svg>
              </a>
            </div>
          </div>
