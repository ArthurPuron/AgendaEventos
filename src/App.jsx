          ...
          >
            ...
            <div className="flex justify-center gap-6">
              ...
              <a 
                ...
                title="Waze"
              >
                <svg className="w-10 h-10 text-[#F5F0ED]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.8,7.2c-1.4-2.4-4.1-3.8-7.3-3.8c-3.2,0-5.9,1.4-7.3,3.8c-0.6,1-0.8,2.1-0.8,3.1c0,3.4,2.3,6.2,5.3,7.1 c-0.1,0.4-0.2,0.9-0.2,1.3c0,2.3,1.9,4.2,4.2,4.2c1.8,0,3.3-1.1,3.9-2.7c1.7-0.3,3-1.8,3-3.5c0-0.3,0-0.5-0.1-0.8 C21.7,13.8,22.3,10.7,18.8,7.2z M12.8,20.7c-1.1,0-2-0.9-2-2c0-0.6,0.3-1.2,0.7-1.6c0.3-0.3,0.7-0.4,1.1-0.4c0.1,0,0.2,0,0.3,0 c1.1,0,2,0.9,2,2S13.9,20.7,12.8,20.7z M17.5,16c0,0.8-0.7,1.5-1.5,1.5c-0.8,0-1.5-0.7-1.5-1.5s0.7-1.5,1.5-1.5C16.8,14.5,17.5,15.2,17.5,16z M8.8,11.2c-0.8,0-1.5-0.7-1.5-1.5s0.7-1.5,1.5-1.5s1.5,0.7,1.5,1.5S9.6,11.2,8.8,11.2z M15.2,11.2c-0.8,0-1.5-0.7-1.5-1.5s0.7-1.5,1.5-1.5s1.5,0.7,1.5,1.5S16,11.2,15.2,11.2z"/>
                </svg>
              </a>
            </div>
          </div>
